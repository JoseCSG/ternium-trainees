...
DROP PROCEDURE IF EXISTS sp_empleados_info_update(VARCHAR(100), VARCHAR(100), VARCHAR(100), VARCHAR(50), DATE, VARCHAR(100), INT, INT, VARCHAR(255), DATE, DATE, INT);
...
ALTER TABLE empleados_login DROP CONSTRAINT IF EXISTS fk_id_empleado_login;
